...
template<typename T> void shake_sort(T* v, int size)
{
    int inicio = 1;
    int fim = size - 1;
    int k;
...
template<typename T> void recursivo::merge(T* v, int inicio, int meio, int fim)
{
...
template<typename T> void recursivo::merge_sort(T* v, int inicio, int fim)
{
    if(inicio < fim)
    {
...
template<typename T> void recursivo::quick_sort(T* v, int inicio, int fim)
{
    if(inicio < fim)
    {
...
template<typename T> void iterativo::quick_sort(T* v, int inicio, int fim)
{
    T* stack = new T [fim - inicio + 1];
    int seta = inicio - 1;
